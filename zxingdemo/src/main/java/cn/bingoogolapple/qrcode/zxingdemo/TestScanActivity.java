...
//        mZXingView.startSpot(); // 开始识别
    ...
    public void saveBitmap(Bitmap bmp) {
        ...
        if (Environment.getExternalStorageState().equals(
            ...
            Toast.makeText(TestScanActivity.this, "保存失败！", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        try {
            ...
            fos.flush();
            fos.close();
            Toast.makeText(TestScanActivity.this, "保存成功,位置:" + filePic.getAbsolutePath(), Toast.LENGTH_SHORT).show();
        } catch (IOException e) {
